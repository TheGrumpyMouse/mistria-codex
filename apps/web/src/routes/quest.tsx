...
/**
 * One quest: who gives it, what it pays, and — for the seals — what it costs.
 *
 * Exists because search now covers quests, and a result has to land somewhere.
 * The screen is deliberately thin: prerequisites and objectives are mostly
 * unrecorded (the wiki's quest page is prose), and the honest version shows the
 * rewards it has rather than scaffolding for data it does not.
 */
